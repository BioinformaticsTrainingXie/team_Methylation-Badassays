...
* these test samples just all happen to be Caucasiansl
...
```{r merged PCA}
pc.merged <- prcomp(scale(merged.all, center=T, scale = T))
...
# scatter plot matrix for the first 5 PCs
splom(PC1to5[,c(2:6,9)], panel = panel.smoothScatter, raster = TRUE)
