...
netFit
saveRDS(netFit, './Data/Processed Data/netFit_alpha75_lambda077.rds')
```
...
y.predictNet <- predict(netFit,  x.test, type = 'prob')
y.predictNet
```
## 3.2 SVM 

```{r SVM predict on test, eval = FALSE}
y.predictSVM <- predict(svmFit,  x.test, type = 'prob')
#throws a warning
y.predictSVM
```
