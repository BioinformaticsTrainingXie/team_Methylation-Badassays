...
plotBetasByType(MSet.noob[,1], main = "Noob", legendPos = "btm")
plotBetasByType(getBeta(eth_preproc_funnorm[,1]), probeTypes = probeTypes, main = "funNorm_noob", legendPos = "btm")
plotBetasByType(getBeta(eth_preproc_quant[,1]), probeTypes = probeTypes, main = "Quantile", legendPos = "btm")
```
