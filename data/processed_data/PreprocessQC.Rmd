...
pfilter(Eth_rgset2, pnthresh = 0.01) #we used the pfilter() function from watermelon package to remove bad detection p value probes and probes with bead count < 3 
```
...
### 3.1 Comparing preprocessing methodology

**preprocessRaw**
```{r}
MSet.raw <- preprocessRaw(Eth_rgset) # converting the red and green channels into a matrix of methylated signals and a matrix of unmethylated signals.
