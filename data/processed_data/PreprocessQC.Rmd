...
- **RGChannelSet** contains the .idat files which is a binary format containing the raw green and red channel intensities.  
...
For both RatiSet and GenomicRatioSet classes include the option of including a copy number measurement. 
